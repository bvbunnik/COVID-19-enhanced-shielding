...
#### Plotting ####
plot <- ggarrange(pinfbase, NULL, pinf125,NULL, pinf075, nrow = 5, ncol =1, align = "v", heights = c(0.5, -0.03, 0.5,-0.05, 0.6), 
...
ggsave(plot, filename = "Phase4.png", dpi = 300, type = "cairo",
