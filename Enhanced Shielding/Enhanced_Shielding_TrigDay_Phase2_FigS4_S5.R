...
ggsave(plot, filename = "FigS4.png", dpi = 300, type = "cairo",
       width = 8.5, height = 11, units = "in")

ggsave(plot1, filename = "FigS5.png", dpi = 300, type = "cairo",
       width = 8.5, height = 11, units = "in")
